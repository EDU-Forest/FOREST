...
public enum StudyErrorCode implements Codable {
    ...
    STUDY_STUDENT_RESULT_NOT_FOUND(HttpStatus.NOT_FOUND,"존재하지 않는 개인 시혐 결과 ID",true),
    STUDY_STUDENT_RESULT_PROBLEM_NOT_FOUND(HttpStatus.NOT_FOUND,"존재하지 않는 개인 시혐 문제 ID",true),
